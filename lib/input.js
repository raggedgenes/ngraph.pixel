...
var  TrackballControls = require('three/examples/jsm/controls/TrackballControls.js').TrackballControls;
...
function createInput(camera, graph, domElement) {
  ...
  // var controls = new TrackballControls(camera, domElement, THREE);
  ...
  eventify(api);
  hitTest.on('nodeleave', passthrough('nodeleave'));
